...
2. Medications (has the scar cream been applied? Mounjaro on Fridays?)
...
- **Content:** Scar cream (schedule-aware: every 2 days → alternate days → daily), Mounjaro (Fridays only)
...
- **Schedule awareness:** Claudinho must calculate which medications apply today (scar cream schedule phase, Mounjaro = Fridays)
...
node /Users/faresende/.openclaw/skills/dashboard-sync/cli.js query \
  --user_id 20436ef5-90f7-4224-9eff-f5ff3cb02530 \
