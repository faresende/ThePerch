...
///
/// IMPORTANT: Live Activity attributes must live in a module shared between the app
/// and the WidgetKit extension. We keep them in PerchSharedKit for that reason.
